# notes: AI Agent Codebase Guide

## Project Architecture

**notes** is a full-stack personal finance management app using a **monorepo structure** with multiple apps and shared Rust crates.
...
crates/
  auth/         # JWT + Argon2 password hashing (nnapi-auth)
  database/     # SQLx repository implementations (nnapi-db)
  engine/       # Domain models, error types, trait definitions (nnapi-core)
packages/
